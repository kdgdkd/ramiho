...
You can define more complex connexions and filters within the mdshcnx files in ramiho's favcnx directory. You can save the last used midish connexion into one of the mdshsvd files. All of these files be directly accessible from the Midish menu. 
